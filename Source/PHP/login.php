...
<html>
    ...
    <body>
        ...
        <div class="container" style="height: 100%;">
            ...
            <form class="form" action = "login connect.php" method="POST" enctype="multipart/form-data" class="form">
                <div class="contain">
                    <hr class="hr">
                    ...
                    <div class="clearfix">
                        ...
                        <button type="submit" name="signup" class="signup">Login</button>
                ...
                <button id="myButton1" class="button" >Create account <br><i><b>Click Here</b></i></button>
