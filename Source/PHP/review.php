...
<html>
    ...
    <body>
        ...
        <div class="container" style="height: 95%;">
            ...
            <div class="addreview"><h1>Add Your review</h1></div>
            <div class="main">
                <form class="form" action = "review connect.php" method="POST" enctype="multipart/form-data">
                    <div id="name">
                    ...
                    <h2 class="about">Review</h2>
                    <textarea type="text" input class = "review" name="review" rows = "5" cols="" placeholder= "Write your Review" required   ></textarea>
                     
                    <h2 class="Rate1">Rate</h2>
                    <input class="rate" type="text" name="rate" placeholder="Out of 10 ">
