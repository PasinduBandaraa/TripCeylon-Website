...
<html>
    ...
    <body>
        ...
        <div class="container" style="height: 110%;">
            <div class="addhotel"><h1>Add Your Hotel</h1></div>
        <div class="main">
            <form class="form" action = "hotel connect.php" method="POST" enctype="multipart/form-data">
                <div id="name">
                    <br><h2 class="name">Name</h2>
                    <input class="firstname" type="text" name="firstname"><br>
                    <lable class="firstlabel">first name</lable>
                    <input class="lastname" type="text" name="lastname">
                    <label class="lastlabel">last name</label>
                </div>

                <h2 class="name">Hotel</h2>
                <input class="hotel" type="text" name="hotel">

                <h2 class="name">Email</h2>
                <input class="email" type="text" name="email">

                <h2 class="num">Phone Number</h2>
                <input class="number" type="text" name="phonenumber">

                <h2 class="about">Description </br> About Hotel</h2>
                <textarea type="text" input class = "descript" name="description" rows = "5" cols="" placeholder= "Description About your hotel" required   ></textarea>
                
                <h2 class="addimg">Add Images</h2>
                <input type="file" id ="file" name="file" accept="images/*" multiple>
                

                <button class="btn1" name="submit" onclick="myFunction()" type="submit">Submit</button>
                <script>
                    function myFunction() {
