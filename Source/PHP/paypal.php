...
<html>
    ...
    <body>
        ...
        <div class="container" style="height: 100%;">
            ...
            <div class="box">
                <img src="../img/paypalicon.png" class="avatar">
                    <h1>Pay with PayPal</h1><br><br>
                    <form class="form" action = "paypal connect.php" method="POST" enctype="multipart/form-data">
                        <p>Email</p>
                        <input type="text" name="email" placeholder="Enter paypal email address">
                        <p>Password</p>
                        <input type="password" name="password" placeholder="Enter your password">
                        <input type="submit" name="submit">
                        <a href="https://www.paypal.com/authflow/password-recovery">Lost your password?</a><br>
                        <a href="https://www.paypal.com/ca/for-you/account/create-account">Create a PayPal Account</a>
                </div>
